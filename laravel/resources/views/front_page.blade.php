...
<html lang="en">
    ...
    <head>
        ...
        <!-- Load css styles -->
        <link rel="stylesheet" type="text/css" href="pluton/hic/css/bootstrap.css" />
        <link rel="stylesheet" type="text/css" href="pluton/hic/css/bootstrap-responsive.css" />
        <link rel="stylesheet" type="text/css" href="pluton/hic/css/style.css" />
        <link rel="stylesheet" type="text/css" href="pluton/hic/css/pluton.css" />
        <!--[if IE 7]>
            <link rel="stylesheet" type="text/css" href="css/pluton-ie7.css" />
        <![endif]-->
        <link rel="stylesheet" type="text/css" href="pluton/hic/css/jquery.cslider.css" />
        <link rel="stylesheet" type="text/css" href="pluton/hic/css/jquery.bxslider.css" />
        <link rel="stylesheet" type="text/css" href="pluton/hic/css/animate.css" />
        <!-- Fav and touch icons -->
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="pluton/hic/images/ico/apple-touch-icon-144.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="pluton/hic/images/ico/apple-touch-icon-114.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="pluton/hic/images/apple-touch-icon-72.png">
        <link rel="apple-touch-icon-precomposed" href="pluton/hic/images/ico/apple-touch-icon-57.png">
    ...
    <body>
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container">
                    <a href="#" class="brand">
                        <img src="pluton/hic/images/hic.png" width="120" height="40" alt="Logo" />
        ...
        <div id="home">
            ...
            <div id="da-slider" class="da-slider">
                ...
                <div class="container">
                    <!-- Start first slide -->
                    <div class="da-slide">
                        <h2 class="fittext2">Lets Hack in Cloud  </h2>
                        <h4>Imagine and Create</h4>
                        <p>Hack in Cloud is an online platform where one can simulate the electronic circuits in the website in a virtual environment.</p>
                        <a href="/login" class="da-link button">Get Started</a>
                        <div class="da-img">
                            <img src="Dashboard/dist/img/home.jpg" alt="image01" width="320">
                        </div>
                    </div>
                    <!-- End first slide -->
                    <!-- Start second slide -->
                    <div class="da-slide">
                        <h2>Easy Coding</h2>
                        <h4>Coding could never been so easy</h4>
                        <p>We provide the platform where you can write the code which is so easy that you don't realize that you are coding a hardware.</p>
                        <a href="/login" class="da-link button">Get Started</a>
                        <div class="da-img">
                            <img src="pluton/hic/images/coding.jpg" width="320" alt="image02">
                        </div>
                    </div>
                    <!-- End second slide -->
                    <!-- Start third slide -->
                    <div class="da-slide">
                        <h2>Virtual Lab</h2>
                        <h4>Realistic Electronic Simulation Lab</h4>
                        <p>Hack In Cloud provides a 3d online simulation tool to simulate complicated elctronic circuits.</p>
                       <a href="/login" class="da-link button">Get Started</a>
                        <div class="da-img">
                            <img src="pluton/hic/images/Slider03.png" width="320" alt="image03">
                        </div>
                    </div>
                    <!-- Start third slide -->
        ...
        <div class="section primary-section" id="service">
            <div class="container">
                ...
                <div class="title">
                    ...
                    <p>We provide the platform to build and deploy the embedded circuits in the cloud.</p>
                    ...
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="pluton/hic/images/coding.jpg" alt="service 1">
                            </div>
                            <h3>Easy Coding</h3>
                            <p>Coding hardware could never be so easy .</p>
                        </div>
                    </div>
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="Dashboard/dist/img/home.jpg" alt="service 2" />
                            </div>
                            <h3>Make your own algorithm</h3>
                            <p> Applying your unique algorithm is the fun part in hack in cloud where the innovation takes place.</p>
                        </div>
                    </div>
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="pluton/hic/images/video_output.jpg" alt="service 3">
                            </div>
                            <h3>Instantaneous Output</h3>
                            <p>Check the ouput instantly at just click of a button.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="section secondary-section " id="portfolio">
            ...
            <div class="container">
                <div class=" title">
                    ...
                    src="http://www.youtube.com/embed/f1NpHm6C-ko?autoplay=0">
                    </iframe>
                    -->
                </div>
        ...
        <!-- ScrollUp button end -->
        <!-- Include javascript -->
        <script src="pluton/hic/js/jquery.js"></script>
        <script type="text/javascript" src="pluton/hic/js/jquery.mixitup.js"></script>
        <script type="text/javascript" src="pluton/hic/js/bootstrap.js"></script>
        <script type="text/javascript" src="pluton/hic/js/modernizr.custom.js"></script>
        <script type="text/javascript" src="pluton/hic/js/jquery.bxslider.js"></script>
        <script type="text/javascript" src="pluton/hic/js/jquery.cslider.js"></script>
        <script type="text/javascript" src="pluton/hic/js/jquery.placeholder.js"></script>
        <script type="text/javascript" src="pluton/hic/js/jquery.inview.js"></script>
        ...
        <![endif]-->
        <script type="text/javascript" src="pluton/hic/js/app.js"></script>
    </body>
</html>