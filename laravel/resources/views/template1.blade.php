...
<head>
    ...
    <!-------------------------------------------------------->
     ...
     <script src="@yield('dot')/Dashboard/block/blockly_compressed.js"></script>
    <script src="@yield('dot')/Dashboard/block/blocks_compressed.js"></script>
    <script src="@yield('dot')/Dashboard/block/javascript_compressed.js"></script>
    <script src="@yield('dot')/Dashboard/block/msg/js/en.js"></script>
    <script src="@yield('dot')/Dashboard/block/generators/javascript/electronics.js"></script>
    <script src="@yield('dot')/Dashboard/block/generators/javascript/procedures.js"></script>

    <script src="@yield('dot')/Dashboard/block/arduino_compressed.js"></script>
    <script src="@yield('dot')/Dashboard/block/Blob.js"></script>
    <script src="@yield('dot')/Dashboard/block/spin.js"></script>
    <script src="@yield('dot')/Dashboard/block/FileSaver.min.js"></script>
    <script src="@yield('dot')/Dashboard/block/blockly_helper.js"></script>
