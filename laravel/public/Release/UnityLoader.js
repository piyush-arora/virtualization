...
{
    var n=document.createElement("script");n.src=URL.createObjectURL(e),n.onload=t,document.body.appendChild(n)
    
}

function LoadJSCode(e,t)
{
    var n=new Blob([e],{type:"text/javascript"});if(Math.fround&&-1==browser.indexOf("Chrome"))LoadJSCodeBlob(n,t);else{console.log("optimizing out Math.fround calls");var o=new FileReader;o.onload=function(e){var n=e.target.result.replace(/Math_fround\(/g,"("),o=new Blob([n],{type:"text/javascript"});LoadJSCodeBlob(o,t)},o.readAsText(n)}
    
}

function DecompressAndLoadFile(e,t,n)
{
    tryServerCompression=!1,e+="gz";var o=new XMLHttpRequest;o.open("GET",e,!0),o.onprogress=n,o.responseType="arraybuffer",o.onload=function(){var n=new Uint8Array(o.response),i=(new Date).getTime(),a=pako.inflate(n),r=(new Date).getTime();console.log("Decompressed "+e+" in "+(r-i)+"ms. You can remove this delay if you configure your web server to host files using gzip compression."),t(a)},o.send(null)
    
}
function LoadCompressedFile(e,t,n)
{
    if(CompressionState.current==CompressionState.Unsupported)return void DecompressAndLoadFile(e,t);if(CompressionState.current==CompressionState.Pending)return void CompressionState.pendingServerRequests.push(
        function()
        {
        ...
        var o=new XMLHttpRequest;o.open("GET",e,!0),o.responseType="arraybuffer",o.onprogress=function(e)
        {
        ...
        },o.onload=function()
        {
            ...
            {
                CompressionState.Set(CompressionState.Supported);var i=new Uint8Array(o.response);t(i)
...
{
    if("undefined"==typeof JSEvents)return void console.log("Player not loaded yet.");var t=JSEvents.canPerformEventHandlerRequests;JSEvents.canPerformEventHandlerRequests=function()
    {
        return 1
...
{
    Uninitialized:0,Pending:1,Unsupported:2,Supported:3,current:0,pendingServerRequests:[],Set:function(e)
    {
        if(CompressionState.current==CompressionState.Pending)
        {
            CompressionState.current=e;for(var t=0;t<CompressionState.pendingServerRequests.length;t++)CompressionState.pendingServerRequests[t]()
...
Module.memoryInitializerRequest=
{
    ...
    {
        if("load"!=e)throw"Unexpected type "+e;this.callback=t
...
function(e)
{
    if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);
    else
    {
        ...
        return function e(t,n,o)
        {
            function i(r,s)
            {
                if(!n[r])
                {
                    if(!t[r])
                    {
                        var l="function"==typeof require&&require;if(!s&&l)return l(r,!0);if(a)return a(r,!0);var d=new Error("Cannot find module '"+r+"'");throw d.code="MODULE_NOT_FOUND",d
            ...
            for(var a="function"==typeof require&&require,r=0;r<o.length;r++)i(o[r]);return i
        ...
        (
            {
                1:[function(e,t,n)
                {
                    "use strict";var o="undefined"!=typeof Uint8Array&&"undefined"!=typeof Uint16Array&&"undefined"!=typeof Int32Array;n.assign=function(e)
                    {
                        for(var t=Array.prototype.slice.call(arguments,1);t.length;)
                        {
                            var n=t.shift();if(n)
                            {
                                if("object"!=typeof n)throw new TypeError(n+"must be non-object");for(var o in n)n.hasOwnProperty(o)&&(e[o]=n[o])
                    ...
                    var i=
                    {
                        ...
                        {
                            if(t.subarray&&e.subarray)return void e.set(t.subarray(n,n+o),i);for(var a=0;o>a;a++)e[i+a]=t[n+a]
                            
                        },flattenChunks:function(e)
                        {
                            var t,n,o,i,a,r;for(o=0,t=0,n=e.length;n>t;t++)o+=e[t].length;for(r=new Uint8Array(o),i=0,t=0,n=e.length;n>t;t++)a=e[t],r.set(a,i),i+=a.length;return r
                ...
                }],2:[function(e,t,n)
                {
                    ...
                    {
                        if(65537>t&&(e.subarray&&r||!e.subarray&&a))return String.fromCharCode.apply(null,i.shrinkBuf(e,t));for(var n="",o=0;t>o;o++)n+=String.fromCharCode(e[o]);return n
                        
                    }
                    var i=e("./common"),a=!0,r=!0;try
                    {
                    ...
                    catch(s)
                    {
                        ...
                        {
                            r=!1}for(var l=new i.Buf8(256),d=0;256>d;d++)l[d]=d>=252?6:d>=248?5:d>=240?4:d>=224?3:d>=192?2:1;l[254]=l[254]=1,n.string2buf=function(e)
                            {
                                var t,n,o,a,r,s=e.length,l=0;for(a=0;s>a;a++)n=e.charCodeAt(a),55296===(64512&n)&&s>a+1&&(o=e.charCodeAt(a+1),56320===(64512&o)&&(n=65536+(n-55296<<10)+(o-56320),a++)),l+=128>n?1:2048>n?2:65536>n?3:4;for(t=new i.Buf8(l),r=0,a=0;l>r;a++)n=e.charCodeAt(a),55296===(64512&n)&&s>a+1&&(o=e.charCodeAt(a+1),56320===(64512&o)&&(n=65536+(n-55296<<10)+(o-56320),a++)),128>n?t[r++]=n:2048>n?(t[r++]=192|n>>>6,t[r++]=128|63&n):65536>n?(t[r++]=224|n>>>12,t[r++]=128|n>>>6&63,t[r++]=128|63&n):(t[r++]=240|n>>>18,t[r++]=128|n>>>12&63,t[r++]=128|n>>>6&63,t[r++]=128|63&n);return t
                            ...
                            {
                                for(var t=new i.Buf8(e.length),n=0,o=t.length;o>n;n++)t[n]=e.charCodeAt(n);return t
                                
                            },
                            n.buf2string=function(e,t)
                            {
                                var n,i,a,r,s=t||e.length,d=new Array(2*s);for(i=0,n=0;s>n;)
                                if(a=e[n++],128>a)d[i++]=a;
                                else if(r=l[a],r>4)d[i++]=65533,n+=r-1;
                                else
                                {
                                    for(a&=2===r?31:3===r?15:7;r>1&&s>n;)a=a<<6|63&e[n++],r--;r>1?d[i++]=65533:65536>a?d[i++]=a:(a-=65536,d[i++]=55296|a>>10&1023,d[i++]=56320|1023&a)
                            ...
                            {
                                var n;for(t=t||e.length,t>e.length&&(t=e.length),n=t-1;n>=0&&128===(192&e[n]);)n--;return 0>n?t:0===n?t:n+l[e[n]]>t?n:t
                ...
                {
                    "use strict";function o(e,t,n,o)
                    {
                        for(var i=65535&e|0,a=e>>>16&65535|0,r=0;0!==n;)
                        {
                            r=n>2e3?2e3:n,n-=r;do i=i+t[o++]|0,a=a+i|0;while(--r);i%=65521,a%=65521
                            
                        }
                        return i|a<<16|0}t.exports=o
                ...
                ],5:[function(e,t,n)
                {
                    "use strict";function o()
                    {
                        ...
                        {
                            e=n;for(var o=0;8>o;o++)e=1&e?3988292384^e>>>1:e>>>1;t[n]=e
                    ...
                    function i(e,t,n,o)
                    {
                        var i=a,r=o+n;e=-1^e;for(var s=o;r>s;s++)e=e>>>8^i[255&(e^t[s])];return-1^e}var a=o();t.exports=i},
                        {
                        ...
                        ],6:[function(e,t,n)
                        {
                            "use strict";function o()
                            {
                                this.text=0,this.time=0,this.xflags=0,this.os=0,this.extra=null,this.extra_len=0,this.name="",this.comment="",this.hcrc=0,this.done=!1}t.exports=o
                        ...
                        {"use strict";var o=30,i=12;t.exports=function(e,t)
                        {
                            var n,a,r,s,l,d,u,c,f,h,p,m,b,w,g,v,k,y,_,x,S,M,C,E,R;n=e.state,a=e.next_in,E=e.input,r=a+(e.avail_in-5),s=e.next_out,R=e.output,l=s-(t-e.avail_out),d=s+(e.avail_out-257),u=n.dmax,c=n.wsize,f=n.whave,h=n.wnext,p=n.window,m=n.hold,b=n.bits,w=n.lencode,g=n.distcode,v=(1<<n.lenbits)-1,k=(1<<n.distbits)-1;e:do
                            {
                                15>b&&(m+=E[a++]<<b,b+=8,m+=E[a++]<<b,b+=8),y=w[m&v];t:for(;;)
                                {
                                    if(_=y>>>24,m>>>=_,b-=_,_=y>>>16&255,0===_)R[s++]=65535&y;
                                    else
                                    {
                                        if(!(16&_))
                                        {if(0===(64&_)){y=w[(65535&y)+(m&(1<<_)-1)];continue t}if(32&_)
                                            {
                                                n.mode=i;break e
                                            
                                            }
                                            e.msg="invalid literal/length code",n.mode=o;break e
                                            
                                        }
                                        x=65535&y,_&=15,_&&(_>b&&(m+=E[a++]<<b,b+=8),x+=m&(1<<_)-1,m>>>=_,b-=_),15>b&&(m+=E[a++]<<b,b+=8,m+=E[a++]<<b,b+=8),y=g[m&k];n:for(;;)
                                        {
                                            if(_=y>>>24,m>>>=_,b-=_,_=y>>>16&255,!(16&_))
                                            {
                                                if(0===(64&_))
                                                {
                                                    y=g[(65535&y)+(m&(1<<_)-1)];continue n
                                                    
                                                }
                                                e.msg="invalid distance code",n.mode=o;break e
                                                
                                            }
                                            if(S=65535&y,_&=15,_>b&&(m+=E[a++]<<b,b+=8,_>b&&(m+=E[a++]<<b,b+=8)),S+=m&(1<<_)-1,S>u)
                                            {
                                                e.msg="invalid distance too far back",n.mode=o;break e
                                            ...
                                            if(m>>>=_,b-=_,_=s-l,S>_)
                                            {
                                                ...
                                                if(M=0,C=p,0===h)
                                                {
                                                    if(M+=c-_,x>_){x-=_;do R[s++]=p[M++];while(--_);M=s-S,C=R
                                                ...
                                                else if(_>h)
                                                {
                                                    if(M+=c+h-_,_-=h,x>_)
                                                    {
                                                        x-=_;do R[s++]=p[M++];while(--_);if(M=0,x>h)
                                                        {
                                                            _=h,x-=_;do R[s++]=p[M++];while(--_);M=s-S,C=R
                                                ...
                                                {
                                                    x-=_;do R[s++]=p[M++];while(--_);M=s-S,C=R
                                                    
                                                }
                                                for(;x>2;)R[s++]=C[M++],R[s++]=C[M++],R[s++]=C[M++],x-=3;x&&(R[s++]=C[M++],x>1&&(R[s++]=C[M++]))
                                                
                                            }
                                            else
                                            {
                                                M=s-S;do R[s++]=R[M++],R[s++]=R[M++],R[s++]=R[M++],x-=3;while(x>2);x&&(R[s++]=R[M++],x>1&&(R[s++]=R[M++]))
                            ...
                            while(r>a&&d>s);x=b>>3,a-=x,b-=x<<3,m&=(1<<b)-1,e.next_in=a,e.next_out=s,e.avail_in=r>a?5+(r-a):5-(a-r),e.avail_out=d>s?257+(d-s):257-(s-d),n.hold=m,n.bits=b
                    ...
                    }],8:[function(e,t,n)
                    {
                        ...
                        function a(e)
                        {
                            var t;return e&&e.state?(t=e.state,e.total_in=e.total_out=t.total=0,e.msg="",t.wrap&&(e.adler=1&t.wrap),t.mode=I,t.last=0,t.havedict=0,t.dmax=32768,t.head=null,t.hold=0,t.bits=0,t.lencode=t.lendyn=new w.Buf32(pe),t.distcode=t.distdyn=new w.Buf32(me),t.sane=1,t.back=-1,R):L
                            
                        }
                        function r(e)
                        {
                            var t;return e&&e.state?(t=e.state,t.wsize=0,t.whave=0,t.wnext=0,a(e)):L
                            
                        }
                        function s(e,t)
                        {
                            var n,o;return e&&e.state?(o=e.state,0>t?(n=0,t=-t):(n=(t>>4)+1,48>t&&(t&=15)),t&&(8>t||t>15)?L:(null!==o.window&&o.wbits!==t&&(o.window=null),o.wrap=n,o.wbits=t,r(e))):L
                            
                        }
                        function l(e,t)
                        {
                            var n,o;return e?(o=new i,e.state=o,o.window=null,n=s(e,t),n!==R&&(e.state=null),n):L
                        ...
                        function u(e)
                        {
                            if(ge)
                            {
                                var t;for(m=new w.Buf32(512),b=new w.Buf32(32),t=0;144>t;)e.lens[t++]=8;for(;256>t;)e.lens[t++]=9;for(;280>t;)e.lens[t++]=7;for(;288>t;)e.lens[t++]=8;for(y(x,e.lens,0,288,m,0,e.work,
                                {
                                    bits:9
                                    
                                }),t=0;32>t;)e.lens[t++]=5;y(S,e.lens,0,32,b,0,e.work,
                                {
                                    bits:5
                                    
                                }),ge=!1}e.lencode=m,e.lenbits=9,e.distcode=b,e.distbits=5
                            
                        }
                        function c(e,t,n,o)
                        {
                            var i,a=e.state;return null===a.window&&(a.wsize=1<<a.wbits,a.wnext=0,a.whave=0,a.window=new w.Buf8(a.wsize)),o>=a.wsize?(w.arraySet(a.window,t,n-a.wsize,a.wsize,0),a.wnext=0,a.whave=a.wsize):(i=a.wsize-a.wnext,i>o&&(i=o),w.arraySet(a.window,t,n-o,i,a.wnext),o-=i,o?(w.arraySet(a.window,t,n-o,o,0),a.wnext=o,a.whave=a.wsize):(a.wnext+=i,a.wnext===a.wsize&&(a.wnext=0),a.whave<a.wsize&&(a.whave+=i))),0
                            
                        }
                        function f(e,t)
                        {
                            var n,i,a,r,s,l,d,f,h,p,m,b,pe,me,be,we,ge,ve,ke,ye,_e,xe,Se,Me,Ce=0,Ee=new w.Buf8(4),Re=[16,17,18,0,8,7,9,6,10,5,11,4,12,3,13,2,14,1,15];if(!e||!e.state||!e.output||!e.input&&0!==e.avail_in)return L;n=e.state,n.mode===J&&(n.mode=K),s=e.next_out,a=e.output,d=e.avail_out,r=e.next_in,i=e.input,l=e.avail_in,f=n.hold,h=n.bits,p=l,m=d,xe=R;e:for(;;)switch(n.mode
                            )
                            {
                                case I:if(0===n.wrap)
                                {
                                    n.mode=K;break}for(;16>h;)
                                    {
                                        if(0===l)break e;l--,f+=i[r++]<<h,h+=8}if(2&n.wrap&&35615===f)
                                        {
                                            n.check=0,Ee[0]=255&f,Ee[1]=f>>>8&255,n.check=v(n.check,Ee,2,0),f=0,h=0,n.mode=U;break
                                        ...
                                        n.dmax=1<<_e,e.adler=n.check=1,n.mode=512&f?H:J,f=0,h=0;break;case U:for(;16>h;)
                                        {
                                            if(0===l)break e;l--,f+=i[r++]<<h,h+=8
                                        ...
                                        n.head&&(n.head.text=f>>8&1),512&n.flags&&(Ee[0]=255&f,Ee[1]=f>>>8&255,n.check=v(n.check,Ee,2,0)),f=0,h=0,n.mode=Z;case Z:for(;32>h;)
                                        {
                                            if(0===l)break e;l--,f+=i[r++]<<h,h+=8
                                            
                                        }
                                        n.head&&(n.head.time=f),512&n.flags&&(Ee[0]=255&f,Ee[1]=f>>>8&255,Ee[2]=f>>>16&255,Ee[3]=f>>>24&255,n.check=v(n.check,Ee,4,0)),f=0,h=0,n.mode=T;case T:for(;16>h;)
                                        {
                                            if(0===l)break e;l--,f+=i[r++]<<h,h+=8}n.head&&(n.head.xflags=255&f,n.head.os=f>>8),512&n.flags&&(Ee[0]=255&f,Ee[1]=f>>>8&255,n.check=v(n.check,Ee,2,0)),f=0,h=0,n.mode=P;case P:if(1024&n.flags)
                                            {
                                                for(;16>h;){if(0===l)break e;l--,f+=i[r++]<<h,h+=8}n.length=f,n.head&&(n.head.extra_len=f),512&n.flags&&(Ee[0]=255&f,Ee[1]=f>>>8&255,n.check=v(n.check,Ee,2,0)),f=0,h=0
                                                
                                            }
                                            else n.head&&(n.head.extra=null);n.mode=N;case N:if(1024&n.flags&&(b=n.length,b>l&&(b=l),b&&(n.head&&(_e=n.head.extra_len-n.length,n.head.extra||(n.head.extra=new Array(n.head.extra_len)),w.arraySet(n.head.extra,i,r,b,_e)),512&n.flags&&(n.check=v(n.check,i,b,r)),l-=b,r+=b,n.length-=b),n.length))break e;n.length=0,n.mode=q;case q:if(2048&n.flags)
                                            {
                                                if(0===l)break e;b=0;do _e=i[r+b++],n.head&&_e&&n.length<65536&&(n.head.name+=String.fromCharCode(_e));while(_e&&l>b);if(512&n.flags&&(n.check=v(n.check,i,b,r)),l-=b,r+=b,_e)break e
                                                
                                            }
                                            else n.head&&(n.head.name=null);n.length=0,n.mode=G;case G:if(4096&n.flags)
                                            {
                                                if(0===l)break e;b=0;do _e=i[r+b++],n.head&&_e&&n.length<65536&&(n.head.comment+=String.fromCharCode(_e));while(_e&&l>b);if(512&n.flags&&(n.check=v(n.check,i,b,r)),l-=b,r+=b,_e)break e
                                                
                                            }
                                            else n.head&&(n.head.comment=null);n.mode=j;case j:if(512&n.flags)
                                            {
                                                for(;16>h;)
                                                {
                                                    if(0===l)break e;l--,f+=i[r++]<<h,h+=8
                                            ...
                                            {
                                                case 0:n.mode=Y;break;case 1:if(u(n),n.mode=te,t===E)
                                                {
                                                    f>>>=2,h-=2;break e
                                                    
                                                }
                                                break;case 2:n.mode=Q;break;case 3:e.msg="invalid block type",n.mode=ce
                                                
                                            }
                                            f>>>=2,h-=2;break;case Y:for(f>>>=7&h,h-=7&h;32>h;)
                                            {
                                                if(0===l)break e;l--,f+=i[r++]<<h,h+=8
